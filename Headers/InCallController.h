...
@class AudioDeviceController, PHAddressBookController, PhoneTabBarController, NSTimer, InCallLCDView, NSArray, SixSquareView, TPSuperBottomBar, TPDialerNumberPad, UINavigationBar, TPBottomBar, TPAudioDeviceView, UIAlertView, TUCall, ConferenceManagementTable, UIView, TPWallpaperView, InCallLCDField;
...
@property(readonly, assign, nonatomic) TPWallpaperView* desktopView;
...
@property(readonly, assign, nonatomic) PHAddressBookController* standaloneContactsViewController;
